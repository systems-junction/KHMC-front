...
function AddEditPurchaseRequest(props) {
  ...
  return (
    <div className="row">
          ...
          <h5 style={{ fontWeight: "bold", color: "white", marginTop: 25, paddingLeft: "15px"}}>
            Patient Details
          </h5>
            ...
            >
              ...
              >
                ...
                <span style={styles.textStyles}>
                  {patientDetails &&
                    patientDetails.firstName && patientDetails.lastName ?  patientDetails.firstName + " " + patientDetails.lastName : "---"}
                </span>

                <span style={styles.headingStyles}>MRN</span>
                <span style={styles.textStyles}>
                  {patientDetails && patientDetails.profileNo ? patientDetails.profileNo.toUpperCase() : "---"}
                </span>

                <span style={styles.headingStyles}>Age</span>
                <span style={styles.textStyles}>
                  {patientDetails && patientDetails.age ? patientDetails.age : "---"}
                </span>
                ...
                <span style={styles.textStyles}>
                  {patientDetails && patientDetails.weight ? patientDetails.weight : "---"} kg
                </span>
              </div>
