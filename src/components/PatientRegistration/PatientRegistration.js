    ...
    >
      ...
      <div className='cPadding'>
        <div className='subheader' style={{ marginLeft: '-10px' }}>
          ...
          {currentUser.staffTypeId.type === 'EDR Receptionist' || currentUser.staffTypeId.type === 'IPR Receptionist' ? <ButtonField
            
            onClick={() => props.history.push('/home/rcm/patientListing')}
            name='viewAll'
          /> : undefined}

{currentUser.staffTypeId.type === 'Lab Technician' ? <ButtonField
            
            onClick={() => props.history.push('/home/rcm/sr/lr/opr')}
            name='viewAll'
          /> : undefined}

{currentUser.staffTypeId.type === 'Radiology/Imaging' ? <ButtonField
            
            onClick={() => props.history.push('/home/rcm/sr/rr/opr')}
            name='viewAll'
          /> : undefined}
          {currentUser.staffTypeId.type === 'Pharmacist' ? <ButtonField
...
{paymentMethod === 'Cash' ? (
                  <div>
                    {currentUser.staffTypeId.type === 'Lab Technician' || currentUser.staffTypeId.type === 'Radiology/Imaging' || currentUser.staffTypeId.type === 'Pharmacist' ? (
                      <Button
                        style={styles.generate}
                        disabled={
                          comingFor === 'add'
                        ...
                        onClick={
                          comingFor === 'add' ? handleGenerateOPR : handleEditOPR
                        }
                        variant='contained'
                        color='primary'
                      >
