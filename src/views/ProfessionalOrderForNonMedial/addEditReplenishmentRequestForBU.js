          ...
          <div style={{ flex: 4, display: "flex", flexDirection: "column" }}>
            <div className="row">
              ...
              <div
                ...
                style={styles.inputContainerForTextField}
              >
                <InputLabelComponent>Order For</InputLabelComponent>
                <input
                  className="textInputStyle"
                  disabled={true}
                  value={"Non Pharmaceutical Order"}
                />
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className={comingFor === "edit" ? "col-md-4" : "col-md-6"}>
                <div style={styles.inputContainerForDropDown}>
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
              {requestedItemsArray && (
                // requestedItemsArray.map((i) => {
                //   return (
                //     <Chip
                //       clickable
                //       onClick={() => handleRequestedItemEdit(i)}
                //       // key={item.itemId._id}
                //       label={
                //         "Item Name: " +
                //         i.itemId.name +
