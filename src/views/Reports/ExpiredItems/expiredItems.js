...
export default function PurchaseRequest(props) {
  ...
  function getPurchaseRequests() {
    ...
    let url = expiredItemsWarehouse;
    if (
      props.history.location.pathname === "/home/reports/fureports/expireditems"
    ) {
      if (!selectedFU) {
  ...
  const handlePrint = () => {
    ...
    if (
      ...
      doc.text(66, 22, "Expired Items Functional Unit Form");
    } else {
      doc.text(72, 22, "Expired Items Warehouse Form");
    }
    doc.setFontSize(12);
    ...
    if (
      ...
      doc.text(149, 270, "Expired Items Functional Unit");
    } else {
      doc.text(156, 270, "Expired Items Warehouse");
    }
    ...
    if (
      ...
      doc.save(`ExpiredItems${fu.fuName}.pdf`);
    } else {
      doc.save(`ExpiredItemsWarehouse.pdf`);
    }
  };
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            "/home/reports/fureports/expireditems" ? (
              <h4>Expired Items Functionl Unit</h4>
            ) : (
              <h4>Expired Items Warehouse</h4>
            )}
          </div>
        </div>
