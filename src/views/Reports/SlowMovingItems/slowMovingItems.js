...
export default function PurchaseRequest(props) {
  ...
  function getPurchaseRequests() {
    ...
    let url = slowMovingItemsWarehouse;
    if (
      props.history.location.pathname ===
      "/home/reports/fureports/slowmovingitems"
    ) {
      if (!selectedFU) {
      ...
      url = slowMovingItemsFU + "/" + selectedFU;
    }
  ...
  const handlePrint = () => {
    ...
    if (
      ...
      doc.text(66, 22, "Slow Moving Items Functional Unit");
    } else {
      doc.text(68, 22, "Slow Moving Items Warehouse");
    }
    doc.setFontSize(12);
    ...
    if (
      ...
      doc.text(149, 270, "Slow Moving Items FuncU");
    } else {
      doc.text(150, 270, "Slow Moving Items Warehouse");
    }
    ...
    if (
      ...
      doc.save(`SlowMovingItems${fu.fuName}.pdf`);
    } else {
      doc.save(`SlowMovingItemsWarehouse.pdf`);
    }
  };
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            {props.history.location.pathname ===
            "/home/reports/fureports/slowmovingitems" ? (
              <h4>Slow Moving Items FuncU</h4>
            ) : (
              <h4>Slow Moving Items Warehouse</h4>
            )}
          </div>
        </div>
