...
// import { stockLevelsWarehouse } from "../../../public/endpoins";
...
//           setPurchaseOrders(res.data.data.reverse());
...
//     doc.text(72, 22, "Items Balance Warehouse Form");
//     doc.setFontSize(12);
...
//     doc.text(35, 50, sd);
//     doc.text(35, 55, ed);
//     doc.text(110, 50, status.charAt(0).toUpperCase() + status.slice(1));
...
//     doc.text(137, 270, "Module:");
//     doc.text(156, 270, "Items Balance Warehouse");
//     doc.text(145, 275, "Date:");
//     doc.text(155, 275, new Date().toLocaleString());

//     doc.save(`ItemsBalanceWarehouse.pdf`);
//   };
...
export default function PurchaseRequest(props) {
  ...
  function getPurchaseRequests() {
    ...
    let url = stockLevelsWarehouse;
    if (
      props.history.location.pathname === "/home/reports/fureports/itemsbalance"
    ) {
      if (!selectedFU) {
  ...
  const handlePrint = () => {
    ...
    if (
      ...
      doc.text(66, 22, "Items Balance Functional Unit Form");
    } else {
      doc.text(72, 22, "Items Balance Warehouse Form");
    }
    doc.setFontSize(12);
    ...
    if (
      ...
      doc.text(149, 270, "Items Balance Functional Unit");
    } else {
      doc.text(156, 270, "Items Balance Warehouse");
    }
    ...
    if (
      ...
      doc.save(`ItemsBalance${fu.fuName}.pdf`);
    } else {
      doc.save(`ItemsBalanceWarehouse.pdf`);
    }
  };
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            "/home/reports/fureports/itemsbalance" ? (
              <h4>Items Balance Functionl Unit</h4>
            ) : (
              <h4>Items Balance Warehouse</h4>
            )}
          </div>
