...
import { supplierfulfillmentPO } from "../../../public/endpoins";
...
export default function PurchaseRequest(props) {
  ...
  const handlePrint = () => {
    ...
    doc.text(72, 22, "Supplier Fulfillment POs Form");
    doc.setFontSize(12);
    ...
    doc.save(`SupplierFulfillmentPOs.pdf`);
  };
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            <h4>Supplier Fulfillment POs</h4>
          </div>
        </div>
