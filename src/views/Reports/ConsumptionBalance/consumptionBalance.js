...
import {
  consumptionBalanceFU,
  getFunctionalUnitUrl,
  consumptionBalanceWarehouse,
...
export default function PurchaseRequest(props) {
  ...
  function getPurchaseRequests() {
    ...
    let url = consumptionBalanceWarehouse;
    if (
      props.history.location.pathname ===
      "/home/reports/fureports/consumptionbalance"
    ) {
      if (!selectedFU) {
      ...
      url = consumptionBalanceFU + "/" + selectedFU;
    }
  ...
  const handlePrint = () => {
    ...
    if (
      ...
      doc.text(65, 22, "Consumption Balance FuncU Form");
    } else {
      doc.text(62, 22, "Consumption Balance Warehouse Form");
    }
    doc.setFontSize(12);
    ...
    if (
      ...
      doc.text(149, 270, "Consumption Balance FuncU");
    } else {
      doc.text(150, 270, "Consumption Balance Warehouse");
    }
    ...
    if (
      ...
      doc.save(`ConsumptionBalance${fu.fuName}.pdf`);
    } else {
      doc.save(`ConsumptionBalanceWarehouse.pdf`);
    }
  };
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            {props.history.location.pathname ===
            "/home/reports/fureports/consumptionbalance" ? (
              <h4>Consumption Balance Functionl Unit</h4>
            ) : (
              <h4>Consumption Balance Warehouse</h4>
            )}
          </div>
        </div>
