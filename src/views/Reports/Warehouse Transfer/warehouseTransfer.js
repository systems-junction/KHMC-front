...
export default function PurchaseRequest(props) {
  ...
  function getPurchaseRequests() {
    ...
    let url = warehouseTransfer + "/" + selectedFU;
    // if (
    //   props.history.location.pathname ===
    //   "/home/reports/warehousereports/others/whtransfer"
    // ) {
    //   if (!selectedFU) {
  ...
  const handlePrint = () => {
    ...
    if (
      ...
      doc.text(75, 22, "Warehouse Transfer Form");
    } else {
      doc.text(62, 22, "Warehouse Transfer Form");
    }
    doc.setFontSize(12);
    ...
    // if (
    //   props.history.location.pathname === "/home/reports/warehousereports/others/whtransfer"
    // ) {
    ...
    if (
      ...
      doc.text(149, 270, "Warehouse Transfer");
    } else {
      doc.text(150, 270, "Warehouse Transfer");
    }
    ...
    if (
      ...
      doc.save(`WarehouseTransfer.pdf`);
    } else {
      doc.save(`WarehouseTransfer.pdf`);
    }
  };
