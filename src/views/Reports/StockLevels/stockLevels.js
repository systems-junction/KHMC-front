...
export default function PurchaseRequest(props) {
  ...
  function getPurchaseRequests() {
    ...
    if (
      props.history.location.pathname === "/home/reports/fureports/stocklevels"
    ) {
      if (!selectedFU) {
  ...
  const handlePrint = () => {
    ...
    if (
      ...
      doc.text(67, 22, "Stock Levels Functional Unit Form");
    } else {
      doc.text(72, 22, "Stock Levels Warehouse Form");
    }
    doc.setFontSize(12);
    ...
    if (
      ...
      doc.text(149, 270, "Stock Level Functional Unit");
    } else {
      doc.text(156, 270, "Stock Level Warehouse");
    }
    ...
    if (
      ...
      doc.save(`StockLevels${fu.fuName}.pdf`);
    } else {
      doc.save(`StockLevelsWarehouse.pdf`);
    }
  };
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            "/home/reports/fureports/stocklevels" ? (
              <h4>Stock Levels Functionl Unit</h4>
            ) : (
              <h4>Stock Levels Warehouse</h4>
            )}
          </div>
        </div>
