...
export default function PurchaseRequest(props) {
  ...
  const handlePrint = () => {
    ...
    doc.text(72, 22, "Purchase Order Tracking Form");
    doc.setFontSize(12);
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            <h4>Purchase Orders Tracking</h4>
          </div>
        </div>
