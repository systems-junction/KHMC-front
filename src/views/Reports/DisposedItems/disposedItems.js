...
const tableDataKeys = [
  ...
  ["batchArray", "returnedQtyPerBatch"],
  ["batchArray", "expiryDatePerBatch"],
];
...
export default function PurchaseRequest(props) {
  ...
  function getPurchaseRequests() {
    ...
    if (
      props.history.location.pathname === "/home/reports/fureports/disposed"
    ) {
      if (!selectedFU) {
      ...
      url = disposedItemsFU + "/" + selectedFU;
    }
  ...
  const handlePrint = () => {
    ...
    if (
      ...
      doc.text(65, 22, "Disposed Items Functional Unit Form");
    } else {
      doc.text(62, 22, "Disposed Items Warehouse Form");
    }
    doc.setFontSize(12);
    ...
    if (
      ...
      doc.text(149, 270, "Disposed Items Functional Unit");
    } else {
      doc.text(150, 270, "Disposed Items Warehouse");
    }
    ...
    if (
      ...
      doc.save(`DisposedItems${fu.fuName}.pdf`);
    } else {
      doc.save(`DisposedItemsWarehouse.pdf`);
    }
  };
      ...
      <div className="cPadding">
        <div className="subheader">
          <div>
            ...
            "/home/reports/fureports/disposed" ? (
              <h4>Disposed Items Functionl Unit</h4>
            ) : (
              <h4>Disposed Items Warehouse</h4>
            )}
          </div>
        </div>
