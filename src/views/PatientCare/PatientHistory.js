...
//                   ].consultationNo.toUpperCase()} for patient MRN: ${res.data.data.patientId.profileNo.toUpperCase()} submitted successfully`,
...
//                   ].residentNoteNo.toUpperCase()} for patient MRN: ${res.data.data.patientId.profileNo.toUpperCase()} added successfully`,
//                   patientDetails: patientDetails,
//                 },
//               })
//             } else if (!res.data.success) {
...
//   const getPatientByInfo = (historyId) => {
//     axios
//       .get(searchpatient + '/' + historyId)
//       .then((res) => {
//         if (res.data.success) {
//           if (res.data.data) {
...
//             setHistoryId(res.data.data._id)
...
>>>>>>> 03c3224fefbff11ab7b6553a48517c010588c50e
