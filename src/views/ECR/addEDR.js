...
//     const selectedRec = props.history.location.state.selectedItem.edrId
//     console.log('Item', props.history.location.state.selectedItem)

//     setId(props.history.location.state.selectedItem.edrId._id)
  ...
  const handleAdd = () => {
    ...
    axios
      ...
      .then((res) => {
        if (res.data.success) {
          console.log('response while adding Medicine Req', res.data.data)
          // props.history.location.state.k(2)
          let path = `/home/rcm/ecr/edr/viewEDR`
