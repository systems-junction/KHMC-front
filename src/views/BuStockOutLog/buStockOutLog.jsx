...
const tableHeading = ["Quantity", "Item Name", "Sale Price", "Action"];
const tableDataKeys = ["qty", ["itemId", "name"], "salePrice"];
...
export default function BuStockOutLog(props) {
  ...
  function deleteBuReturn() {
    ...
    axios
      .delete(deleteBuStockOutLogUrl + "/" + params._id)
      .then((res) => {
        if (res.data.success) {
          setdeleteItem("");
