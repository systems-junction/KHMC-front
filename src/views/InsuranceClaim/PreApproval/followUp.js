...
import { addfollowup, uploadsUrl } from '../../../public/endpoins'
    ...
    >
      ...
      <div className='cPadding'>
        ...
        <div className='container-fluid' style={styles.patientDetails}>
          <div className='row'>
            <div className='col-md-12'>
              <InputLabel style={styles.styleForLabel}>
                Extension Notes
              </InputLabel>
              <textarea
          ...
          <div className='row'>
            ...
            >
              ...
              <input
                ...
                value={
                  approvalPerson
                    ? approvalPerson.firstName + ' ' + approvalPerson.lastName
                    : currentUser.name
                }
                onChange={onChangeValue}
                className='textInputStyle'
            ...
            {file !== '' && file.includes('\\') ? (
              ...
              <>
                {file !== '' && file.slice(file.length - 3) !== 'pdf' ? (
                  ...
                  >
                    <a href={uploadsUrl + file} style={{ color: '#2c6ddd' }}>
                      Click here to open file
                    </a>
                  </div>
                ) : (
