...
import {
  getLaboratoryServiceUrl,
  deleteLaboratoryServiceUrl,
  socketUrl,
...
export default function Vendor(props) {
  ...
  function deleteVendor() {
    ...
    axios
      .delete(deleteLaboratoryServiceUrl + '/' + params._id)
      .then((res) => {
        if (res.data.success) {
          setdeleteItem('')
