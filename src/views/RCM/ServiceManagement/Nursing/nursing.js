...
import {
  getNursingServiceUrl,
  deleteNursingServiceUrl,
  socketUrl,
...
export default function Vendor(props) {
  ...
  function deleteVendor() {
    ...
    axios
      .delete(deleteNursingServiceUrl + '/' + params._id)
      .then((res) => {
        if (res.data.success) {
          setdeleteItem('')
      ...
      <div className='cPadding'>
        <div className='subheader'>
          ...
          <div>
            ...
            {/* <img src={Search} style={{width:50, height:50}} /> */}
          </div>
        </div>
