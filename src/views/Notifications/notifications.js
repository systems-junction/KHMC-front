          ...
          <ul className="notification-info-panel">
            {notificationData.map((message, index) => {
              return message.sendTo.map((checkRead, indexx) => {
                if (
                  checkRead.read === false &&
                  checkRead.userId._id === cookie.load("current_user")._id
                ) {
                  ...
                  return (
                    <li
                      ...
                      onClick={() =>
                        handleViewNotification(message, checkRead.userId._id)
                      }
                    >
                      <div className="timestamp d-flex">
                        ...
                        <span className="time p-2">
                          {getWhen(message.date)}
                        </span>
                      </div>
