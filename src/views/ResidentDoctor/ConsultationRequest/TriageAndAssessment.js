...
function TriageAndAssessment(props) {
  ...
  const [specifyGeneralAppearance, setSpecifyGeneralAppearance] = useState(
    false
  );
  ...
  const handleSubmitAssessment = (e) => {
    ...
    axios
      ...
      .then((res) => {
        if (res.data.success) {
          console.log(
            "Update Patient data consultation request: ",
            res.data.data
          );
          props.history.push({
            pathname: "success",
